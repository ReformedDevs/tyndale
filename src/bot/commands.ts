...
export function buildSlashCommands(translations: readonly string[]) {
  ...
  const devotionalCommand = new SlashCommandBuilder()
    .setName("devotional")
  ...
  const personCommand = new SlashCommandBuilder()
    .setName("person")
  ...
  return [helpCommand, versionCommand, serverCommand, devotionalCommand, personCommand];
}
